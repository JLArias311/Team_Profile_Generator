...
// const templatesDir is creating an absolute path to the templates folder
...
const render = employees => {
  ...
  html.push(...employees
    ...
    // Here we are only filtering through the inserted objects and copying them with function renderManager and pushing to html array
  );
  html.push(...employees
    .filter(employee => employee.getRole() === "Engineer")
    .map(engineer => renderEngineer(engineer))
  );
  // We are doing the same here for Engineer's
  html.push(...employees
...
const renderManager = manager => {
  // This is where the templateDir absolute path comes into play. It it grabbing the templates folder and grabbing the manager.html file to read.
